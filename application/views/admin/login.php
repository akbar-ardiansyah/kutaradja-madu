...
<head>
    ...
    <link href="<?= site_url(); ?>assets/css/pages/login/classic/login-5.css" rel="stylesheet" type="text/css" />
...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading">
    ...
    <div class="d-flex flex-column flex-root">
        ...
        <div class="login login-5 login-signin-on d-flex flex-row-fluid" id="kt_login">
            <div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(<?= site_url(); ?>assets/media/bg/bg-2.jpg);">
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    <!--begin::Login Header-->
                    <div class="d-flex flex-center mb-15">
                        <a href="#">
                            <img src="<?= site_url(); ?>assets/media/logos/logo-letter-13.png" class="max-h-75px" alt="logo" />
                        </a>
                    </div>
                    <!--end::Login Header-->
                    ...
                    <div class="login-signin">
                        <div class="mb-20">
                            <h3 class="opacity-40 font-weight-normal text-capitalize">masuk sebagai Admin</h3>
                            <p class="opacity-40">Enter your details to login to your account:</p>
                        </div>

                        <form class="form" novalidate="novalidate" id="kt_login_signin_form">
                            <div class="form-group">
                                <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="text" placeholder="username" id="username" name="username" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                <input class="form-control h-auto text-white bg-white-o-5 rounded-pill border-0 py-4 px-8" type="password" placeholder="Password" id="password" name="password" />
                            </div>
                    ...
                    <div class="login-forgot">
                        <div class="mb-20">
                            <h3 class="opacity-40 font-weight-normal">Lupa Password ?</h3>
                            <p class="opacity-40">Masukkan email anda untuk mereset password</p>
                        </div>
    ...
    <script src="<?= site_url(); ?>assets/js/pages/custom/login/login-general.js"></script>
    <!--end::Page Scripts-->
    <script>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.user_level == 1) {
                        ...
                        swal.fire({
                            text: "Maaf, email atau password salah, mohon periksa kembali dan coba lagi",
                            icon: "error",
